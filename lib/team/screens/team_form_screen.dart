  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (response['ok'] == true) {
        ...
        if (!mounted) return;
        _showError(response['error'] ?? 'Failed to save team');
      }
    } catch (e) {
      if (!mounted) return;
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Center(
                      child: Text('Preview updates as you edit the URL.',
                          style: TextStyle(
                ...
                children: [
                  Expanded(
                    child: Column(
                      children: [
                        _buildColorSwatch(
                            _teamColourController, "Primary", true),
                      ],
                    ),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        _buildColorSwatch(
                            _teamColourSecondaryController, "Secondary", false),
                      ],
                    ),
                  ),
                ],
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        _buildLabel('Base'),
                        _buildTextField(_baseController, hint: 'Milton Keynes'),
                      ],
                    ),
                  ),
                ],
              ...
              _buildTextField(_foundedYearController,
                  hint: '2005', keyboardType: TextInputType.number),
              const SizedBox(height: 24),
              ...
              _buildTextField(_wikiController,
                ...
                children: [
                  Expanded(
                      child: _buildStatField(
                          'Constructors\'', _constructorsController)),
                  const SizedBox(width: 12),
                  Expanded(
                      child:
                          _buildStatField('Drivers\'', _driversController)),
                  const SizedBox(width: 12),
                  Expanded(
                      child: _buildStatField('Points', _pointsController)),
                ],
              ),
              ...
              _buildTextField(_racesEnteredController, keyboardType: TextInputType.number),
              const SizedBox(height: 24),
              ...
              Row(
                children: [
                  Expanded(
                      child: _buildStatField(
                          'Avg Lap (ms)', _avgLapController, isDouble: true)),
                  const SizedBox(width: 12),
                  Expanded(
                      child: _buildStatField(
                          'Best Lap (ms)', _bestLapController)),
                ],
              ),
              const SizedBox(height: 16),
              ...
              Row(
                children: [
                  Expanded(
                      child: _buildStatField(
                          'Avg Pit (ms)', _avgPitController, isDouble: true)),
                  const SizedBox(width: 12),
                  Expanded(
                      child: _buildStatField(
                          'Top Speed (kph)', _topSpeedController, isDouble: true)),
                ],
              ),
              const SizedBox(height: 16),
              
              _buildLabel('Laps Completed'),
              _buildTextField(_lapsCompletedController, keyboardType: TextInputType.number),
              const SizedBox(height: 24),

              _buildLabel('Engines'),
              _buildTextField(_enginesController,
                  hint: 'Honda, TAG Heuer...', maxLines: 2),
              const SizedBox(height: 6),
              const Text('Comma-separated engine supplier list.',
                  style: TextStyle(color: Color(0x99FFFFFF), fontSize: 11)),
              const SizedBox(height: 24),
